# Allow profilefields of type multiselection to show in the WordPress Cyclos plugin

## Create a Script of type 'Service interceptor'
...
## Create a Service interceptor

- Script: User search interceptor
- Services: UserService
- Operations: search

## Add permissions to the WP user Group or Product
